...
class EditPasswordRootView: UIView {
    ...
    let subtitleLabel: UILabel = {
        ...
        label.textAlignment = .center
        label.text = "This is the password you use to login to the app."
        return label
    }()
    
    let newPasswordTextField: RequiredTextField = {
        let textField = RequiredTextField()
        textField.font = UIFont.Lato.regular
        textField.textColor = UIColor.appBlack
        textField.isSecureTextEntry = true
        textField.returnKeyType = .done
        textField.attributedPlaceholder = NSAttributedString(string: "New password*", attributes: [.foregroundColor: UIColor.appDarkGray])
        return textField
    }()
    
    let confirmPasswordTextField: RequiredTextField = {
        let textField = RequiredTextField()
        textField.font = UIFont.Lato.regular
        textField.textColor = UIColor.appBlack
        textField.isSecureTextEntry = true
        textField.returnKeyType = .done
        textField.attributedPlaceholder = NSAttributedString(string: "Confirm new password*", attributes: [.foregroundColor: UIColor.appDarkGray])
        return textField
    }()
    
    let currentPasswordTextField: RequiredTextField = {
        let textField = RequiredTextField()
        textField.font = UIFont.Lato.regular
        textField.textColor = UIColor.appBlack
        textField.isSecureTextEntry = true
    ...
    private func configureLayout() {
        ...
        [newPasswordTextField, confirmPasswordTextField, currentPasswordTextField].forEach {
