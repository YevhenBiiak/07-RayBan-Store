...
class SunglassesCategoriesPresenterImpl {
...
extension SunglassesCategoriesPresenterImpl: CategoriesPresenter {
    ...
    func viewDidLoad() async {
        ...
        let headerSection = CategorySection(items: [
            ...
            CategoryItem(viewModel: CategoryCellViewModel(name: "ALL SUNGLASSES"))
        ])
        let productSection = CategorySection(items: [CategoryItem()])
        
        await view?.display(title: "SUNGLASSES")
...
private extension SunglassesCategoriesPresenterImpl {
